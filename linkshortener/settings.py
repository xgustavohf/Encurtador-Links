...
SECRET_KEY = 'django-insecure-(901dn6+pd7r+-wx&*2vtto&#jz8ta(lazmluuzor7_whr4do%'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

#Abaixo conf. VERCEL ".vercel.app"
ALLOWED_HOSTS = ["*"]
...
STATIC_URL = 'static/'
STATIC_ROOT = os.path.join(BASE_DIR, 'shortener/static/admin/')
